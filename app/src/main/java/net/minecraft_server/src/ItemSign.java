	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6,
		...
		if (i7 == 0) {
			...
			if (!Block.signPost.canPlaceBlockAt(world3, i4, i5, i6)) {
				...
				if (i7 == 1) {
					world3.setBlockAndMetadataWithNotify(i4, i5, i6, Block.signPost.blockID, MathHelper.floor_double(
							(double) ((entityPlayer2.rotationYaw + 180.0F) * 16.0F / 360.0F) + 0.5D) & 15);
				} else {
