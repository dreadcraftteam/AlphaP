				...
				if (z3) {
					...
					if (slot12 != null) {
						...
						if (itemStack13 == null) {
							...
							if (itemStack13.itemID == itemStack14.itemID && (!itemStack13.getHasSubtypes()
									|| itemStack13.getItemDamage() == itemStack14.getItemDamage())) {
								i10 = i2 == 0 ? itemStack14.stackSize : 1;
						...
						} else if (itemStack13.itemID == itemStack14.itemID && itemStack14.getMaxStackSize() > 1
								&& (!itemStack13.getHasSubtypes()
										|| itemStack13.getItemDamage() == itemStack14.getItemDamage())) {
	...
	protected void func_28126_a(ItemStack itemStack1, int i2, int i3, boolean z4) {
		...
		if (itemStack1.func_21132_c()) {
			while (itemStack1.stackSize > 0 && (!z4 && i5 < i3 || z4 && i5 >= i2)) {
				...
				if (itemStack7 != null && itemStack7.itemID == itemStack1.itemID
						&& (!itemStack1.getHasSubtypes() || itemStack1.getItemDamage() == itemStack7.getItemDamage())) {
