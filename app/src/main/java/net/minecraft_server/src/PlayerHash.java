...
public class PlayerHash {
	...
	public Object getValueByKey(long j1) {
		...
		for (PlayerHashEntry playerHashEntry4 = this.hashArray[getHashIndex(i3,
				this.hashArray.length)]; playerHashEntry4 != null; playerHashEntry4 = playerHashEntry4.nextEntry) {
