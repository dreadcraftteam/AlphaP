...
public class MapGenCavesHell extends MapGenBase {
	protected void func_4106_a(int i1, int i2, byte[] b3, double d4, double d6, double d8) {
		this.func_4105_a(i1, i2, b3, d4, d6, d8, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
	}

	protected void func_4105_a(int i1, int i2, byte[] b3, double d4, double d6, double d8, float f10, float f11,
			float f12, int i13, int i14, double d15) {
		...
		if (i14 <= 0) {
			int i24 = this.field_947_a * 16 - 16;
		...
		for (boolean z26 = random23.nextInt(6) == 0; i13 < i14; ++i13) {
			...
			if (!z51 && i13 == i25 && f10 > 1.0F) {
				this.func_4105_a(i1, i2, b3, d4, d6, d8, random23.nextFloat() * 0.5F + 0.5F, f11 - (float) Math.PI / 2F,
						f12 / 3.0F, i13, i14, 1.0D);
				this.func_4105_a(i1, i2, b3, d4, d6, d8, random23.nextFloat() * 0.5F + 0.5F, f11 + (float) Math.PI / 2F,
						f12 / 3.0F, i13, i14, 1.0D);
				return;
			}
			...
			if (z51 || random23.nextInt(4) != 0) {
				...
				if (d4 >= d17 - 16.0D - d27 * 2.0D && d8 >= d19 - 16.0D - d27 * 2.0D && d4 <= d17 + 16.0D + d27 * 2.0D
						&& d8 <= d19 + 16.0D + d27 * 2.0D) {
						...
						for (int i41 = i54; !z55 && i41 < i38; ++i41) {
							for (int i42 = i36 + 1; !z55 && i42 >= i53 - 1; --i42) {
								...
								if (i42 >= 0 && i42 < 128) {
									...
									if (i42 != i53 - 1 && i40 != i52 && i40 != i34 - 1 && i41 != i54
											&& i41 != i38 - 1) {
										i42 = i53;
									}
								}
							...
							for (i43 = i54; i43 < i38; ++i43) {
								...
								for (int i47 = i36 - 1; i47 >= i53; --i47) {
									...
									if (d48 > -0.7D && d56 * d56 + d48 * d48 + d44 * d44 < 1.0D) {
										byte b50 = b3[i46];
										if (b50 == Block.bloodStone.blockID || b50 == Block.dirt.blockID
												|| b50 == Block.grass.blockID) {
											b3[i46] = 0;
										}
									}
	...
	protected void func_666_a(World world1, int i2, int i3, int i4, int i5, byte[] b6) {
		...
		for (int i8 = 0; i8 < i7; ++i8) {
			...
			if (this.rand.nextInt(4) == 0) {
				this.func_4106_a(i4, i5, b6, d9, d11, d13);
			...
			for (int i16 = 0; i16 < i15; ++i16) {
				...
				this.func_4105_a(i4, i5, b6, d9, d11, d13, f19 * 2.0F, f17, f18, 0, 0, 0.5D);
			}
		}
