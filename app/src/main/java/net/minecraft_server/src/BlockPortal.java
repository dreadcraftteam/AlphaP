...
public class BlockPortal extends BlockBreakable {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
		float f5;
		float f6;
		if (iBlockAccess1.getBlockId(i2 - 1, i3, i4) != this.blockID
				&& iBlockAccess1.getBlockId(i2 + 1, i3, i4) != this.blockID) {
			f5 = 0.125F;
			f6 = 0.5F;
	...
	public boolean tryToCreatePortal(World world1, int i2, int i3, int i4) {
		byte b5 = 0;
		byte b6 = 0;
		if (world1.getBlockId(i2 - 1, i3, i4) == Block.obsidian.blockID
				|| world1.getBlockId(i2 + 1, i3, i4) == Block.obsidian.blockID) {
			b5 = 1;
		}

		if (world1.getBlockId(i2, i3, i4 - 1) == Block.obsidian.blockID
				|| world1.getBlockId(i2, i3, i4 + 1) == Block.obsidian.blockID) {
			b6 = 1;
		}
	...
	public void onNeighborBlockChange(World world1, int i2, int i3, int i4, int i5) {
		...
		if (world1.getBlockId(i2, i8 - 1, i4) != Block.obsidian.blockID) {
			...
			if (i9 == 3 && world1.getBlockId(i2, i8 + i9, i4) == Block.obsidian.blockID) {
				boolean z10 = world1.getBlockId(i2 - 1, i3, i4) == this.blockID
						|| world1.getBlockId(i2 + 1, i3, i4) == this.blockID;
				boolean z11 = world1.getBlockId(i2, i3, i4 - 1) == this.blockID
						|| world1.getBlockId(i2, i3, i4 + 1) == this.blockID;
				if (z10 && z11) {
					world1.setBlockWithNotify(i2, i3, i4, 0);
				} else if ((world1.getBlockId(i2 + b6, i3, i4 + b7) != Block.obsidian.blockID
						|| world1.getBlockId(i2 - b6, i3, i4 - b7) != this.blockID)
						&& (world1.getBlockId(i2 - b6, i3, i4 - b7) != Block.obsidian.blockID
								|| world1.getBlockId(i2 + b6, i3, i4 + b7) != this.blockID)) {
					world1.setBlockWithNotify(i2, i3, i4, 0);
				}
			} else {
