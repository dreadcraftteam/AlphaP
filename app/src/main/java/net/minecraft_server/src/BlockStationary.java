	...
	public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
		if (this.blockMaterial == Material.lava) {
			...
			for (int i7 = 0; i7 < i6; ++i7) {
				...
				if (i8 == 0) {
					if (this.func_4033_j(world1, i2 - 1, i3, i4) || this.func_4033_j(world1, i2 + 1, i3, i4)
							|| this.func_4033_j(world1, i2, i3, i4 - 1) || this.func_4033_j(world1, i2, i3, i4 + 1)
							|| this.func_4033_j(world1, i2, i3 - 1, i4) || this.func_4033_j(world1, i2, i3 + 1, i4)) {
