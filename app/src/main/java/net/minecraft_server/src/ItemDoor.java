	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6,
		...
		if (i7 != 1) {
			...
			if (!block8.canPlaceBlockAt(world3, i4, i5, i6)) {
				...
				int i9 = MathHelper.floor_double((double) ((entityPlayer2.rotationYaw + 180.0F) * 4.0F / 360.0F) - 0.5D)
						& 3;
				byte b10 = 0;
				byte b11 = 0;
				if (i9 == 0) {
				...
				int i12 = (world3.isBlockNormalCube(i4 - b10, i5, i6 - b11) ? 1 : 0)
						+ (world3.isBlockNormalCube(i4 - b10, i5 + 1, i6 - b11) ? 1 : 0);
				int i13 = (world3.isBlockNormalCube(i4 + b10, i5, i6 + b11) ? 1 : 0)
						+ (world3.isBlockNormalCube(i4 + b10, i5 + 1, i6 + b11) ? 1 : 0);
				boolean z14 = world3.getBlockId(i4 - b10, i5, i6 - b11) == block8.blockID
						|| world3.getBlockId(i4 - b10, i5 + 1, i6 - b11) == block8.blockID;
				boolean z15 = world3.getBlockId(i4 + b10, i5, i6 + b11) == block8.blockID
						|| world3.getBlockId(i4 + b10, i5 + 1, i6 + b11) == block8.blockID;
				boolean z16 = false;
				if (z14 && !z15) {
					z16 = true;
