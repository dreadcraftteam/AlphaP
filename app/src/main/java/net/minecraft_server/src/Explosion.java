...
public class Explosion {
	...
	public void doExplosion() {
		...
		List list9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder,
				AxisAlignedBB.getBoundingBoxFromPool((double) i3, (double) i5, (double) i7, (double) i4, (double) i29,
						(double) i30));
		...
		for (int i11 = 0; i11 < list9.size(); ++i11) {
			...
			double d13 = entity33.getDistance(this.explosionX, this.explosionY, this.explosionZ)
			...
			if (d13 <= 1.0D) {
				...
				d17 /= d39;
				d19 /= d39;
				double d40 = (double) this.worldObj.func_494_a(vec3D31, entity33.boundingBox);
				double d41 = (1.0D - d13) * d40;
				entity33.attackEntityFrom(this.exploder,
						(int) ((d41 * d41 + d41) / 2.0D * 8.0D * (double) this.explosionSize + 1.0D));
	...
	public void doEffects(boolean z1) {
		...
		for (int i3 = arrayList2.size() - 1; i3 >= 0; --i3) {
			...
			if (z1) {
				...
				d17 *= d23;
				d19 *= d23;
				this.worldObj.spawnParticle("explode", (d9 + this.explosionX * 1.0D) / 2.0D,
						(d11 + this.explosionY * 1.0D) / 2.0D, (d13 + this.explosionZ * 1.0D) / 2.0D, d15, d17, d19);
				this.worldObj.spawnParticle("smoke", d9, d11, d13, d15, d17, d19);
			}

			if (i8 > 0) {
				Block.blocksList[i8].dropBlockAsItemWithChance(this.worldObj, i5, i6, i7,
						this.worldObj.getBlockMetadata(i5, i6, i7), 0.3F);
