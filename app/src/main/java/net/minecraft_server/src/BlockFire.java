...
public class BlockFire extends Block {
	...
	public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
		...
		if (!z6 && world1.func_27068_v()
				&& (world1.canLightningStrikeAt(i2, i3, i4) || world1.canLightningStrikeAt(i2 - 1, i3, i4)
						|| world1.canLightningStrikeAt(i2 + 1, i3, i4) || world1.canLightningStrikeAt(i2, i3, i4 - 1)
						|| world1.canLightningStrikeAt(i2, i3, i4 + 1))) {
			world1.setBlockWithNotify(i2, i3, i4, 0);
		} else {
						...
						for (int i10 = i3 - 1; i10 <= i3 + 4; ++i10) {
							if (i8 != i2 || i10 != i3 || i9 != i4) {
								...
								if (i12 > 0) {
									...
									if (i13 > 0 && random5.nextInt(i11) <= i13
											&& (!world1.func_27068_v() || !world1.canLightningStrikeAt(i8, i10, i9))
											&& !world1.canLightningStrikeAt(i8 - 1, i10, i4)
											&& !world1.canLightningStrikeAt(i8 + 1, i10, i9)
											&& !world1.canLightningStrikeAt(i8, i10, i9 - 1)
											&& !world1.canLightningStrikeAt(i8, i10, i9 + 1)) {
	...
	private boolean func_268_g(World world1, int i2, int i3, int i4) {
		return this.canBlockCatchFire(world1, i2 + 1, i3, i4) ? true
				: (this.canBlockCatchFire(world1, i2 - 1, i3, i4) ? true
						: (this.canBlockCatchFire(world1, i2, i3 - 1, i4) ? true
								: (this.canBlockCatchFire(world1, i2, i3 + 1, i4) ? true
										: (this.canBlockCatchFire(world1, i2, i3, i4 - 1) ? true
												: this.canBlockCatchFire(world1, i2, i3, i4 + 1)))));
	}
