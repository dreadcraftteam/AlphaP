...
public class ChunkCoordinates implements Comparable {
	...
	public boolean equals(Object object1) {
		if (!(object1 instanceof ChunkCoordinates)) {
			...
			return this.posX == chunkCoordinates2.posX && this.posY == chunkCoordinates2.posY
					&& this.posZ == chunkCoordinates2.posZ;
		}
	}
	...
	public int compareChunkCoordinate(ChunkCoordinates chunkCoordinates1) {
		return this.posY == chunkCoordinates1.posY
				? (this.posZ == chunkCoordinates1.posZ ? this.posX - chunkCoordinates1.posX
						: this.posZ - chunkCoordinates1.posZ)
				: this.posY - chunkCoordinates1.posY;
	}
