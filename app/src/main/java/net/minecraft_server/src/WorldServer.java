...
public class WorldServer extends World {
	...
	public void updateEntityWithOptionalForce(Entity entity1, boolean z2) {
		if (!this.mcServer.spawnPeacefulMobs
				&& (entity1 instanceof EntityAnimal || entity1 instanceof EntityWaterMob)) {
	...
	public List getTileEntityList(int i1, int i2, int i3, int i4, int i5, int i6) {
		...
		for (int i8 = 0; i8 < this.loadedTileEntityList.size(); ++i8) {
			...
			if (tileEntity9.xCoord >= i1 && tileEntity9.yCoord >= i2 && tileEntity9.zCoord >= i3
					&& tileEntity9.xCoord < i4 && tileEntity9.yCoord < i5 && tileEntity9.zCoord < i6) {
	...
	public void sendTrackedEntityStatusUpdatePacket(Entity entity1, byte b2) {
		...
		this.mcServer.getEntityTracker(this.worldProvider.worldType).sendPacketToTrackedPlayersAndTrackedEntity(entity1,
				packet38EntityStatus3);
	}
	...
	public Explosion newExplosion(Entity entity1, double d2, double d4, double d6, float f8, boolean z9) {
		...
		this.mcServer.configManager.sendPacketToPlayersAroundPoint(d2, d4, d6, 64.0D, this.worldProvider.worldType,
				new Packet60Explosion(d2, d4, d6, f8, explosion10.destroyedBlockPositions));
		return explosion10;
	}

	public void playNoteAt(int i1, int i2, int i3, int i4, int i5) {
		super.playNoteAt(i1, i2, i3, i4, i5);
		this.mcServer.configManager.sendPacketToPlayersAroundPoint((double) i1, (double) i2, (double) i3, 64.0D,
				this.worldProvider.worldType, new Packet54PlayNoteBlock(i1, i2, i3, i4, i5));
	}
