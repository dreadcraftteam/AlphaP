...
public class WorldGenMinable extends WorldGenerator {
	...
	public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
		...
		for (int i19 = 0; i19 <= this.numberOfBlocks; ++i19) {
			...
			double d28 = (double) (MathHelper.sin((float) i19 * (float) Math.PI / (float) this.numberOfBlocks) + 1.0F)
					* d26 + 1.0D;
			double d30 = (double) (MathHelper.sin((float) i19 * (float) Math.PI / (float) this.numberOfBlocks) + 1.0F)
					* d26 + 1.0D;
					...
					for (int i41 = i33; i41 <= i36; ++i41) {
						...
						if (d39 * d39 + d42 * d42 < 1.0D) {
							for (int i44 = i34; i44 <= i37; ++i44) {
								...
								if (d39 * d39 + d42 * d42 + d45 * d45 < 1.0D
										&& world1.getBlockId(i38, i41, i44) == Block.stone.blockID) {
