...
public class PathPoint {
	...
	public PathPoint(int i1, int i2, int i3) {
		...
		this.yCoord = i2;
		this.zCoord = i3;
		this.hash = func_22203_a(i1, i2, i3);
	}

	public static int func_22203_a(int i0, int i1, int i2) {
		return i1 & 255 | (i0 & 32767) << 8 | (i2 & 32767) << 24 | (i0 < 0 ? Integer.MIN_VALUE : 0)
				| (i2 < 0 ? 32768 : 0);
	}
	...
	public boolean equals(Object object1) {
		if (!(object1 instanceof PathPoint)) {
			...
			return this.hash == pathPoint2.hash && this.xCoord == pathPoint2.xCoord && this.yCoord == pathPoint2.yCoord
					&& this.zCoord == pathPoint2.zCoord;
		}
	}
