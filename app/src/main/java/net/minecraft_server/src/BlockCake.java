...
public class BlockCake extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world1, int i2, int i3, int i4) {
		...
		float f7 = (float) (1 + i5 * 2) / 16.0F;
		float f8 = 0.5F;
		return AxisAlignedBB.getBoundingBoxFromPool((double) ((float) i2 + f7), (double) i3, (double) ((float) i4 + f6),
				(double) ((float) (i2 + 1) - f6), (double) ((float) i3 + f8 - f6), (double) ((float) (i4 + 1) - f6));
	}

	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		return i1 == 1 ? this.blockIndexInTexture
				: (i1 == 0 ? this.blockIndexInTexture + 3
						: (i2 > 0 && i1 == 4 ? this.blockIndexInTexture + 2 : this.blockIndexInTexture + 1));
	}

	public int getBlockTextureFromSide(int i1) {
		return i1 == 1 ? this.blockIndexInTexture
				: (i1 == 0 ? this.blockIndexInTexture + 3 : this.blockIndexInTexture + 1);
	}
