...
public class BlockRedstoneTorch extends BlockTorch {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		return i1 == 1 ? Block.redstoneWire.getBlockTextureFromSideAndMetadata(i1, i2)
	...
	public boolean isPoweringTo(IBlockAccess iBlockAccess1, int i2, int i3, int i4, int i5) {
		if (!this.torchActive) {
			...
			return i6 == 5 && i5 == 1 ? false
					: (i6 == 3 && i5 == 3 ? false
							: (i6 == 4 && i5 == 2 ? false : (i6 == 1 && i5 == 5 ? false : i6 != 2 || i5 != 4)));
		}
	}

	private boolean func_30003_g(World world1, int i2, int i3, int i4) {
		int i5 = world1.getBlockMetadata(i2, i3, i4);
		return i5 == 5 && world1.isBlockIndirectlyProvidingPowerTo(i2, i3 - 1, i4, 0) ? true
	...
	public void updateTick(World world1, int i2, int i3, int i4, Random random5) {
		boolean z6 = this.func_30003_g(world1, i2, i3, i4);

		while (torchUpdates.size() > 0
				&& world1.getWorldTime() - ((RedstoneUpdateInfo) torchUpdates.get(0)).updateTime > 100L) {
			torchUpdates.remove(0);
		}

		if (this.torchActive) {
			if (z6) {
				world1.setBlockAndMetadataWithNotify(i2, i3, i4, Block.torchRedstoneIdle.blockID,
						world1.getBlockMetadata(i2, i3, i4));
				if (this.checkForBurnout(world1, i2, i3, i4, true)) {
					world1.playSoundEffect((double) ((float) i2 + 0.5F), (double) ((float) i3 + 0.5F),
							(double) ((float) i4 + 0.5F), "random.fizz", 0.5F,
							2.6F + (world1.rand.nextFloat() - world1.rand.nextFloat()) * 0.8F);
			...
			world1.setBlockAndMetadataWithNotify(i2, i3, i4, Block.torchRedstoneActive.blockID,
					world1.getBlockMetadata(i2, i3, i4));
		}
