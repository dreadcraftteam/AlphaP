...
public class BlockPumpkin extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		if (i1 == 1) {
			...
			return i2 == 2 && i1 == 2 ? i3
					: (i2 == 3 && i1 == 5 ? i3
							: (i2 == 0 && i1 == 3 ? i3 : (i2 == 1 && i1 == 4 ? i3 : this.blockIndexInTexture + 16)));
		}
	}

	public int getBlockTextureFromSide(int i1) {
		return i1 == 1 ? this.blockIndexInTexture
				: (i1 == 0 ? this.blockIndexInTexture
						: (i1 == 3 ? this.blockIndexInTexture + 1 + 16 : this.blockIndexInTexture + 16));
	}
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		...
		return (i5 == 0 || Block.blocksList[i5].blockMaterial.func_27090_g())
