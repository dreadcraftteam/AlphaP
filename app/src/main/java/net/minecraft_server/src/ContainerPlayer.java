...
public class ContainerPlayer extends Container {
	...
	public ContainerPlayer(InventoryPlayer inventoryPlayer1, boolean z2) {
		...
		for (i3 = 0; i3 < 4; ++i3) {
			this.addSlot(new SlotArmor(this, inventoryPlayer1, inventoryPlayer1.getSizeInventory() - 1 - i3, 8,
					8 + i3 * 18, i3));
		}
	...
	public ItemStack func_27086_a(int i1) {
		...
		if (slot3 != null && slot3.func_27006_b()) {
			...
			if (i1 == 0) {
				this.func_28126_a(itemStack4, 9, 45, true);
			} else if (i1 >= 9 && i1 < 36) {
				this.func_28126_a(itemStack4, 36, 45, false);
			} else if (i1 >= 36 && i1 < 45) {
				this.func_28126_a(itemStack4, 9, 36, false);
			} else {
				this.func_28126_a(itemStack4, 9, 45, false);
			}
