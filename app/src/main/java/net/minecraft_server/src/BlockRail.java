...
public class BlockRail extends Block {
	...
	public void onNeighborBlockChange(World world, int i, int j, int k, int l) {
		if (!world.multiplayerWorld) {
			...
			if (flag) {
				...
				flag1 = flag1 || this.func_27032_a(world, i, j, k, i1, true, 0)
						|| this.func_27032_a(world, i, j, k, i1, false, 0);
				boolean flag2 = false;
				if (flag1 && (i1 & 8) == 0) {
			...
			} else if (l > 0 && Block.blocksList[l].canProvidePower() && !this.field_27034_a
					&& RailLogic.getNAdjacentTracks(new RailLogic(this, world, i, j, k)) == 3) {
	...
	private boolean func_27032_a(World world, int i, int j, int k, int l, boolean flag, int i1) {
		if (i1 >= 8) {
			...
			return this.func_27031_a(world, i, j, k, flag, i1, j1) ? true
					: flag1 && this.func_27031_a(world, i, j - 1, k, flag, i1, j1);
		}
	}
		...
		if (j1 == Block.railPowered.blockID) {
			...
			if ((k1 & 8) != 0) {
				if (!world.isBlockIndirectlyGettingPowered(i, j, k)
						&& !world.isBlockIndirectlyGettingPowered(i, j + 1, k)) {
					return this.func_27032_a(world, i, j, k, k1, flag, l + 1);
				}
