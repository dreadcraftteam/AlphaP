...
public class ItemShears extends Item {
	...
	public boolean func_25007_a(ItemStack itemStack1, int i2, int i3, int i4, int i5, EntityLiving entityLiving6) {
		...
		return super.func_25007_a(itemStack1, i2, i3, i4, i5, entityLiving6);
	}
	...
	public float getStrVsBlock(ItemStack itemStack1, Block block2) {
		return block2.blockID != Block.web.blockID && block2.blockID != Block.leaves.blockID
				? (block2.blockID == Block.cloth.blockID ? 5.0F : super.getStrVsBlock(itemStack1, block2))
				: 15.0F;
	}
}
