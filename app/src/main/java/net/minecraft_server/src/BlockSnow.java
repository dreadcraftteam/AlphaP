...
public class BlockSnow extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world1, int i2, int i3, int i4) {
		...
		return i5 >= 3 ? AxisAlignedBB.getBoundingBoxFromPool((double) i2 + this.minX, (double) i3 + this.minY,
				(double) i4 + this.minZ, (double) i2 + this.maxX, (double) ((float) i3 + 0.5F), (double) i4 + this.maxZ)
				: null;
	}
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		...
		return i5 != 0 && Block.blocksList[i5].isOpaqueCube() ? world1.getBlockMaterial(i2, i3 - 1, i4).getIsSolid()
				: false;
	}
	...
	public void harvestBlock(World world1, EntityPlayer entityPlayer2, int i3, int i4, int i5, int i6) {
		...
		EntityItem entityItem15 = new EntityItem(world1, (double) i3 + d9, (double) i4 + d11, (double) i5 + d13,
				new ItemStack(i7, 1, 0));
