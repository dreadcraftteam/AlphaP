...
public class EntitySquid extends EntityWaterMob {
	...
	public void onLivingUpdate() {
		...
		if (this.isInWater()) {
			...
			this.field_21063_a += (-((float) Math.atan2((double) f1, this.motionY)) * 180.0F / (float) Math.PI
					- this.field_21063_a) * 0.1F;
		} else {
	...
	protected void updatePlayerActionState() {
		if (this.rand.nextInt(50) == 0 || !this.inWater
				|| this.field_21052_ar == 0.0F && this.field_21051_as == 0.0F && this.field_21050_at == 0.0F) {
