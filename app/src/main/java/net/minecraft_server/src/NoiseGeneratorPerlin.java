...
public class NoiseGeneratorPerlin extends NoiseGenerator {
	...
	public double generateNoise(double d1, double d3, double d5) {
		...
		return this.lerp(d23,
				this.lerp(d21,
						this.lerp(d19, this.grad(this.permutations[i26], d7, d9, d11),
								this.grad(this.permutations[i29], d7 - 1.0D, d9, d11)),
						this.lerp(d19, this.grad(this.permutations[i27], d7, d9 - 1.0D, d11),
								this.grad(this.permutations[i30], d7 - 1.0D, d9 - 1.0D, d11))),
				this.lerp(d21,
						this.lerp(d19, this.grad(this.permutations[i26 + 1], d7, d9, d11 - 1.0D),
								this.grad(this.permutations[i29 + 1], d7 - 1.0D, d9, d11 - 1.0D)),
						this.lerp(d19, this.grad(this.permutations[i27 + 1], d7, d9 - 1.0D, d11 - 1.0D),
								this.grad(this.permutations[i30 + 1], d7 - 1.0D, d9 - 1.0D, d11 - 1.0D))));
	}
	...
	public double func_642_a(double d1, double d3) {
		return this.generateNoise(d1, d3, 0.0D);
	}

	public void func_646_a(double[] d1, double d2, double d4, double d6, int i8, int i9, int i10, double d11,
			double d13, double d15, double d17) {
		int i10001;
		int i19;
		int i22;
		double d31;
		...
		if (i9 == 1) {
			...
			for (int i30 = 0; i30 < i8; ++i30) {
				...
				for (i37 = 0; i37 < i10; ++i37) {
					...
					d70 = this.lerp(d35, this.func_4102_a(this.permutations[i66], d31, d38),
							this.grad(this.permutations[i22], d31 - 1.0D, 0.0D, d38));
					d73 = this.lerp(d35, this.grad(this.permutations[i66 + 1], d31, 0.0D, d38 - 1.0D),
							this.grad(this.permutations[i22 + 1], d31 - 1.0D, 0.0D, d38 - 1.0D));
				...
				for (int i44 = 0; i44 < i10; ++i44) {
					...
					for (int i51 = 0; i51 < i9; ++i51) {
						...
						if (i51 == 0 || i55 != i22) {
							...
							d29 = this.lerp(d42, this.grad(this.permutations[i71], d38, d52, d45),
									this.grad(this.permutations[i75], d38 - 1.0D, d52, d45));
							d31 = this.lerp(d42, this.grad(this.permutations[i72], d38, d52 - 1.0D, d45),
									this.grad(this.permutations[i76], d38 - 1.0D, d52 - 1.0D, d45));
							d33 = this.lerp(d42, this.grad(this.permutations[i71 + 1], d38, d52, d45 - 1.0D),
									this.grad(this.permutations[i75 + 1], d38 - 1.0D, d52, d45 - 1.0D));
							d35 = this.lerp(d42, this.grad(this.permutations[i72 + 1], d38, d52 - 1.0D, d45 - 1.0D),
									this.grad(this.permutations[i76 + 1], d38 - 1.0D, d52 - 1.0D, d45 - 1.0D));
						}
