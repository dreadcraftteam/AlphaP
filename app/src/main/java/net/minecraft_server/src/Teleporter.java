...
public class Teleporter {
	...
	public boolean createExitLocation(World world1, Entity entity2) {
		...
		int i11 = i8;
		int i12 = 0;
		int i13 = this.field_28117_a.nextInt(4);
		...
		for (i14 = i6 - b3; i14 <= i6 + b3; ++i14) {
			...
			for (i17 = i8 - b3; i17 <= i8 + b3; ++i17) {
				...
				label293: for (i20 = 127; i20 >= 0; --i20) {
							...
							for (i24 = 0; i24 < 3; ++i24) {
								for (i25 = 0; i25 < 4; ++i25) {
									for (i26 = -1; i26 < 4; ++i26) {
										...
										if (i26 < 0 && !world1.getBlockMaterial(i27, i28, i29).isSolid()
												|| i26 >= 0 && !world1.isAirBlock(i27, i28, i29)) {
											continue label293;
										}
									}
								}
		...
		if (d4 < 0.0D) {
			for (i14 = i6 - b3; i14 <= i6 + b3; ++i14) {
				...
				for (i17 = i8 - b3; i17 <= i8 + b3; ++i17) {
					...
					label231: for (i20 = 127; i20 >= 0; --i20) {
						if (world1.isAirBlock(i14, i20, i17)) {
							...
							for (i21 = i13; i21 < i13 + 2; ++i21) {
								...
								for (i24 = 0; i24 < 4; ++i24) {
									for (i25 = -1; i25 < 4; ++i25) {
										...
										i27 = i20 + i25;
										i28 = i17 + (i24 - 1) * i23;
										if (i25 < 0 && !world1.getBlockMaterial(i26, i27, i28).isSolid()
												|| i25 >= 0 && !world1.isAirBlock(i26, i27, i28)) {
											continue label231;
										}
									}
								}
