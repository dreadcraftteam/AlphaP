...
public class Item {
	...
	public static Item bucketMilk = (new ItemBucket(79, -1)).setIconCoord(13, 4).setItemName("milk")
	...
	public static ItemShears field_31022_bc = (ItemShears) (new ItemShears(103)).setIconCoord(13, 5)
			.setItemName("shears");
