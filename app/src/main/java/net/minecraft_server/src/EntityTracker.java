...
public class EntityTracker {
	...
	public void untrackEntity(Entity entity1) {
		...
		EntityTrackerEntry entityTrackerEntry5 = (EntityTrackerEntry) this.trackedEntityHashTable
				.removeObject(entity1.entityId);
	...
	public void updateTrackedEntities() {
		...
		while (iterator2.hasNext()) {
			...
			if (entityTrackerEntry3.playerEntitiesUpdated
					&& entityTrackerEntry3.trackedEntity instanceof EntityPlayerMP) {
	...
	public void sendPacketToTrackedPlayers(Entity entity1, Packet packet2) {
		EntityTrackerEntry entityTrackerEntry3 = (EntityTrackerEntry) this.trackedEntityHashTable
				.lookup(entity1.entityId);
