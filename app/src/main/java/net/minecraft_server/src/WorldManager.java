...
public class WorldManager implements IWorldAccess {
	...
	public void func_28133_a(EntityPlayer entityPlayer1, int i2, int i3, int i4, int i5, int i6) {
		this.mcServer.configManager.func_28171_a(entityPlayer1, (double) i3, (double) i4, (double) i5, 64.0D,
				this.field_28134_b.worldProvider.worldType, new Packet61DoorChange(i2, i3, i4, i5, i6));
	}
}
