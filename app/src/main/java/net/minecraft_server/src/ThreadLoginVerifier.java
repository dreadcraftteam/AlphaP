...
class ThreadLoginVerifier extends Thread {
	...
	public void run() {
		try {
			...
			URL uRL2 = new URL("http://www.minecraft.net/game/checkserver.jsp?user="
					+ URLEncoder.encode(this.loginPacket.username, "UTF-8") + "&serverId="
					+ URLEncoder.encode(string1, "UTF-8"));
