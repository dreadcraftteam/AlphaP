	...
	public void onUpdate() {
		if(this.blockID == 0) {
			...
			if(this.onGround) {
				...
				this.motionY *= -0.5D;
				this.setEntityDead();
				if((!this.worldObj.canBlockBePlacedAt(this.blockID, i, j, k, true, 1) || BlockSand.canFallBelow(this.worldObj, i, j - 1, k) || !this.worldObj.setBlockWithNotify(i, j, k, this.blockID)) && !this.worldObj.multiplayerWorld) {
