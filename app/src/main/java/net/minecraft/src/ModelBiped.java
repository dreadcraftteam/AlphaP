...
public class ModelBiped extends ModelBase {
	...
	private static Minecraft mcs;
	Minecraft mc = mcs;
	private static GameSettings options;
	GameSettings gm = options;
	...
	public void setRotationAngles(float f1, float f2, float f3, float f4, float f5, float f6) {
		...
		System.out.println("mc.options: " + (this.mc != null ? this.mc.gm : "mc is null"));
		//System.out.println("playeranim: "
				//+ (this.mc != null && this.mc.gm != null ? this.mc.gm.playeranim : "cannot get playeranim"));

		// this.mc = mc;
		// this.mc.gm.loadOptions();
