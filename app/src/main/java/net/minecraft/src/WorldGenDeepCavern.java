		...
		for(x1 = 0; x1 < xSize; ++x1) {
			for(i39 = 0; i39 < zSize; ++i39) {
				for(y1 = 0; y1 < ySize; ++y1) {
					try {
						boolean z40 = !aflag[(x1 * zSize + i39) * ySize + y1] && (x1 < 15 && aflag[((x1 + 1) * zSize + i39) * ySize + y1] || x1 > 0 && aflag[((x1 - 1) * zSize + i39) * ySize + y1] || i39 < 15 && aflag[(x1 * zSize + i39 + 1) * ySize + y1] || i39 > 0 && aflag[(x1 * zSize + (i39 - 1)) * ySize + y1] || y1 < 7 && aflag[(x1 * zSize + i39) * ySize + y1 + 1] || y1 > 0 && aflag[(x1 * zSize + i39) * ySize + y1 - 1]);
						if(z40) {
							...
							if(y1 < 4 && !material42.isSolid() && world.getBlockId(x + x1, y + y1, z + i39) != this.id) {
								return false;
							}
						}
			...
			for(i39 = 0; i39 < zSize; ++i39) {
				for(y1 = 0; y1 < ySize; ++y1) {
					if(aflag[(x1 * zSize + i39) * ySize + y1]) {
						...
						if(this.id == 0 || i41 == Block.stone.blockID || i41 == Block.dirt.blockID || i41 == Block.gravel.blockID || i41 == Block.sand.blockID || i41 == Block.sandStone.blockID || i41 == 0 && i41 != this.id) {
