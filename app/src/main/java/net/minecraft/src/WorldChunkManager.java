...
public class WorldChunkManager {
	...
	public BiomeGenBase getBiomeGenAt(int i, int j) {
		return this.func_4069_a(i, j, 1, 1)[0];
	}

	public double getTemperature(int i, int j) {
		this.temperature = this.field_4194_e.func_4112_a(this.temperature, (double)i, (double)j, 1, 1, 0.02500000037252903D, 0.02500000037252903D, 0.5D);
		return this.temperature[0];
	}

	public double getLavaLevel(int x, int z) {
		this.lavaLevel = this.llRand.func_4112_a(this.lavaLevel, (double)x, (double)z, 1, 1, 0.02500000037252903D, 0.02500000037252903D, 0.5D);
	...
	public double[] getTemperatures(double[] ad, int i, int j, int k, int l) {
		...
		ad = this.field_4194_e.func_4112_a(ad, (double)i, (double)j, k, l, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
		this.field_4196_c = this.field_4192_g.func_4112_a(this.field_4196_c, (double)i, (double)j, k, l, 0.25D, 0.25D, 0.5882352941176471D);
		int i1 = 0;
	...
	public BiomeGenBase[] loadBlockGeneratorData(BiomeGenBase[] abiomegenbase, int i, int j, int k, int l) {
		...
		this.temperature = this.field_4194_e.func_4112_a(this.temperature, (double)i, (double)j, k, k, 0.02500000037252903D, 0.02500000037252903D, 0.25D);
		this.humidity = this.field_4193_f.func_4112_a(this.humidity, (double)i, (double)j, k, k, (double)0.05F, (double)0.05F, 0.3333333333333333D);
		this.field_4196_c = this.field_4192_g.func_4112_a(this.field_4196_c, (double)i, (double)j, k, k, 0.25D, 0.25D, 0.5882352941176471D);
		int i1 = 0;
