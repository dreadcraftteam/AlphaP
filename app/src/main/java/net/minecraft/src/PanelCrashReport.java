...
public class PanelCrashReport extends Panel {
	public PanelCrashReport(UnexpectedThrowable parammh) {
		...
		if(str1.contains("Pixel format not accelerated")) {
			...
			str4 = str4 + "      -----------------------      \n";
			str4 = str4 + "\n";
			str4 = str4 + "AlphaPlus was unable to start because it failed to find an accelerated OpenGL mode.\n";
			...
			str4 = str4 + "      ----------------------      \n";
			str4 = str4 + "\n";
			str4 = str4 + "AlphaPlus has stopped running because it encountered a problem.\n";
			str4 = str4 + "\n";
